...
Before going in the dark more than two times:
...
The map is an edible thing.  The description of the map is "A photocopy of a map that you found at the library. [first time]You were browsing in the local history section and found [only]". The player carries the map.
...
Instead of inserting the brass lantern into the mailbox, say "The brass lantern is too big to fit in the mailbox".
...
Instead of searching rubble for the third time:
